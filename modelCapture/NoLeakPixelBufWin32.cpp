...
CNoLeakPixelBufWin32::CNoLeakPixelBufWin32(osg::GraphicsContext::Traits* traits) :
_initialized(false),
_valid(false),
_realized(false),
_boundBuffer(0)
...
CNoLeakPixelBufWin32::~CNoLeakPixelBufWin32()
{
	closeImplementation();
}

void CNoLeakPixelBufWin32::init()
{
...
bool CNoLeakPixelBufWin32::realizeImplementation()
{
	if (_realized)
	{
...
void CNoLeakPixelBufWin32::closeImplementation()
{
	if (_hwnd)
	{
		WGLExtensions* wgle = WGLExtensions::instance();
...
bool CNoLeakPixelBufWin32::makeCurrentImplementation()
{
...
bool CNoLeakPixelBufWin32::makeContextCurrentImplementation(GraphicsContext* readContext)
{
	WGLExtensions* wgle = WGLExtensions::instance();
...
bool CNoLeakPixelBufWin32::releaseContextImplementation()
{
	if (!_realized)
	{
...
void CNoLeakPixelBufWin32::bindPBufferToTextureImplementation(GLenum buffer)
{
	WGLExtensions* wgle = WGLExtensions::instance();
...
void CNoLeakPixelBufWin32::swapBuffersImplementation()
{
	SwapBuffers(_hdc);
}
